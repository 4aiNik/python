...
class Cell:
    ...
    def __add__(self, other):
        return self.cells_number + other.cells_number
    ...
    def make_order(self, cells_in_row):
        full_rows = self.cells_number // cells_in_row
        remainder = self.cells_number % cells_in_row
        return '\n'.join(['*' * cells_in_row for _ in range(full_rows)] + (['*' * remainder] if remainder != 0 else []))
